...
public class Stage
{
    ...
    public float GnomeCount;
    public float DangerStartLevel;
    public float DangerGrowSpeed;
    public List<Wave> Waves;

    public Stage(int coal = 0, int gold = 0, int obstacle = 0, int gnome = 0, float dangerStartLevel = 0, float dangerGrowSpeed = 0, List<Wave> waves = null)
    {
        this.CoalCount = coal;
        this.GoldCount = gold;
        this.ObstacleCount = obstacle;
        this.GnomeCount = gnome;
